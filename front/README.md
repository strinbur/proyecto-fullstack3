...
- `src/api/api.ts` usa `baseURL: http://localhost:8080/bff`.
...
## Notas
- El frontend está configurado para usar el BFF en `localhost:8080`; si cambias el puerto del BFF, actualiza `src/api/api.ts`.
